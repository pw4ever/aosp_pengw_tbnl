package info.voidstar.android.tbnl.figurehead;
...
import info.voidstar.android.tbnl.figurehead.R;
...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("info.voidstar.android.tbnl.figurehead.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("info.voidstar.android.tbnl.figurehead.MainActivity");
